...
set +e
NO_ONBOARD=1 HOME=/home/clawuser USER=clawuser LOGNAME=clawuser timeout --foreground --kill-after=30 300 bash `"`$TMP`" -- --no-onboard > >(tee /tmp/openclaw-install.log) 2>&1
INSTALL_RC=`$?
set -e
